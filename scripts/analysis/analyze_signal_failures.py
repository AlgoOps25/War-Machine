...
Moved from app/ml/analyze_signal_failures.py (Batch B audit, 2026-03-16).
Standalone dev diagnostic — reads signal_outcomes.csv, produces loss-pattern
analysis and saves losers_with_potential.csv + ticker_performance.csv.

Usage:
    cd <repo_root>
    python scripts/analysis/analyze_signal_failures.py

Expected input file:
    signal_outcomes.csv  (in the current working directory)
"""
import pandas as pd
import numpy as np
