...
Usage:
    python scripts/database/db_diagnostic.py
    DATABASE_URL=postgres://... python scripts/database/db_diagnostic.py

Note: Moved from tests/db_diagnostic.py — this is a CLI ops tool,
not a pytest test. The tests/ directory is reserved for pytest-discoverable
test files (test_*.py).
"""
import sys
